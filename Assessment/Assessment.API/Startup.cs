...
namespace Assessment.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IConnectionString>(sp => sp.GetRequiredService<IOptions<MongoDBConnectionSettings>>().Value);

            services.AddSingleton<Data.Repository.IRepositoryWrapper, Data.Repository.RepositoryWrapper>();
